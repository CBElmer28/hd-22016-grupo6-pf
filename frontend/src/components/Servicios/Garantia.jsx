...
const imgBanner = 'https://www.mercedes-benz.com.pe/documents/13373260/13374667/imagen_postventa_mb_pe.webp/be663b17-1d34-db76-4d6b-17bf7c10b84d?t=1751447221943';
const imgSecundaria = 'https://www.mercedes-benz.com.pe/documents/13373260/13374667/garantia-1.webp/f10b916c-3dc6-89ed-64ef-941d2f2117ed?t=1751447262599';
    ...
    <div className="bg-black min-h-screen flex flex-col text-white">
      ...
      <section className="relative w-full h-[40vh] md:h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 drop-shadow-lg">Garantía Zentauri Quead</h1>
      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-4 py-10">
        <div className="bg-neutral-900 rounded-xl shadow-lg p-8 mb-8 flex flex-col md:flex-row items-center gap-8 border border-neutral-700">
          ...
          <div className="flex-1">
            ...
            <ul className="list-disc pl-6 space-y-2 text-white/90">
              ...
              <li>Cobertura ante cualquier defecto de fabricación o materiales en tu vehículo Zentauri Quead.</li>
        ...
        <div className="bg-neutral-800 rounded-xl shadow p-6 flex flex-col md:flex-row items-center justify-between mb-8 border border-neutral-700 gap-4 md:gap-0">
          <div className="mb-2 md:mb-0 flex-1">
            <h3 className="text-xl font-bold text-blue-300 mb-1">¿Necesitas agendar una cita en taller?</h3>
            <p className="text-white/90 text-base md:text-sm leading-snug">Nuestro equipo Zentauri Quead está siempre disponible para ayudarte con cualquier consulta o servicio relacionado con la garantía de tu vehículo.</p>
          </div>
          <a
            href="#"
        ...
        <div className="bg-neutral-900 rounded-xl shadow p-6 border border-neutral-700">
          ...
          <p className="text-white/80 text-sm">
            La garantía Zentauri Quead protege tu vehículo ante defectos de fabricación y materiales durante 2 años desde la entrega, sin límite de kilometraje. Para más información, consulta los términos oficiales o acércate a tu concesionario Zentauri Quead autorizado.
          </p>
          <a
