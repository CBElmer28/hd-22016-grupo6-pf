                            ...
                            <div className="col">
                                <Card className="h-100 shadow-sm">
                                    ...
                                    <Card.Body>
                                        ...
                                        <Button variant="primary" className="w-100">Agendar cita</Button>
                                    </Card.Body>
                                </Card>
                            </div>
                            ...
                            <div className="col">
                                <Card className="h-100 shadow-sm">
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            Encuentra tu concesionario Mercedes-Benz más cercano.
                                        </Card.Text>
                        ...
                        <Card className="shadow-sm mb-5">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    <Card.Img src={imagenManuales} alt="Manuales" className="h-100" style={{ objectFit: 'cover' }} />
                                </div>
                                <div className="col-md-8">
                                    <Card.Body className="p-4">
                                        <Card.Title>Manuales de instrucciones</Card.Title>
                                        <Card.Text>
                                            Accede al manual completo de tu vehículo Mercedes-Benz en formato digital o descargado en PDF.
                                        </Card.Text>
                            ...
                            <div className="row row-cols-1 row-cols-md-2 g-4">
                                ...
                                <div className="col">
                                    <Card className="h-100 shadow-sm">
                                        <div className="row g-0 h-100">
                                            <div className="col-md-4">
                                                <Card.Img src={imagenEmail} alt="Contacto por email" className="h-100" style={{ objectFit: 'cover' }} />
                                            </div>
                                            <div className="col-md-8">
                                                <Card.Body className="p-4">
                                                    <Card.Title className="text-xl font-semibold">E-Mail</Card.Title>
                                                    <Card.Text>
                                                        ¿Prefieres escribirnos? No dudes en ponerte en contacto con nosotros en cualquier momento a través de nuestro formulario de contacto.
                                                    </Card.Text>
                                ...
                                <div className="col">
                                    <Card className="h-100 shadow-sm">
                                        <div className="row g-0 h-100">
                                            <div className="col-md-4">
                                                <Card.Img src={imagenAsistencia} alt="Asistencia Mercedes" className="h-100" style={{ objectFit: 'cover' }} />
                                            </div>
                                            <div className="col-md-8">
                                                <Card.Body className="p-4">
                                                    <Card.Title className="text-xl font-semibold">Asistencia</Card.Title>
                                                    <Card.Text>
                                                        Puedes contactarnos llamando al: <strong>(01) 512-9827</strong> o escribiendo a: <strong>ayudazentauriqead@gmail.com</strong>.
                                                    </Card.Text>
                                ...
                                <div className="col">
                                    <Card className="h-100 shadow-sm">
                                        <div className="row g-0 h-100">
                                            <div className="col-md-4">
                                                <Card.Img src={imagenChat} alt="Chat Mercedes" className="h-100" style={{ objectFit: 'cover' }} />
                                            </div>
                                            <div className="col-md-8">
                                                <Card.Body className="p-4">
                                                    <Card.Title className="text-xl font-semibold">Chat</Card.Title>
                                                    <Card.Text>
                                                        También puedes chatear con nosotros haciendo clic en el icono de chat situado en la esquina inferior derecha.
                                                    </Card.Text>
                                ...
                                <div className="col">
                                    <Card className="h-100 shadow-sm">
                                        <div className="row g-0 h-100">
                                            <div className="col-md-4">
                                                <Card.Img src={imagenPreguntas} alt="Preguntas Mercedes" className="h-100" style={{ objectFit: 'cover' }} />
                                            </div>
                                            <div className="col-md-8">
                                                <Card.Body className="p-4">
                                                    <Card.Title className="text-xl font-semibold">Mercedes-Benz</Card.Title>
                                                    <Card.Text>
                                                        ¿Tienes alguna pregunta sobre Mercedes-Benz? Estaremos encantados de ayudarte.
                                                    </Card.Text>
